...
* **Local Folders**: A folder that doesnâ€™t have git configured.  
...
* **Settings**: When a Project is created, it always starts with the default security preset where it has read and write access to all of your projectâ€™s folders and will ask for permission to run all terminal commands. These settings can be modified and apply to all agents within this project.  
