...
* By default, the agent only has access to the folders inside your Project and the applicationâ€™s local app data directory `~/.gemini/antigravity/` (which contains Artifacts, Knowledge Items, etc.).
