...
```text
plugins/<plugin-name>/
â”œâ”€â”€ plugin.json       # Required marker file
â”œâ”€â”€ mcp_config.json   # Optional MCP server definitions
â”œâ”€â”€ hooks.json        # Optional hooks definition
â”œâ”€â”€ skills/           # Optional skills
â”‚   â””â”€â”€ <skill-name>/
â”‚       â””â”€â”€ SKILL.md
â””â”€â”€ rules/            # Optional rules
    â””â”€â”€ <rule-name>.md
```
