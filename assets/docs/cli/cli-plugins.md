...
```text
~/.gemini/antigravity-cli/plugins/<plugin_name>/
â”œâ”€â”€ plugin.json                 # Required package marker file
â”œâ”€â”€ mcp_config.json             # Optional Model Context Protocol servers
â”œâ”€â”€ hooks.json                  # Optional pre/post tool event hooks
â”œâ”€â”€ skills/                     # Optional specialized skills directory
â”œâ”€â”€ agents/                     # Optional subagent definition templates
â””â”€â”€ rules/                      # Optional custom codebase rules files
```
