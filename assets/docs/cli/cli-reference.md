...
| **`/agents`**         | Tools & Tasks  | â€”                          | Open the Agent Manager Panel to monitor background subagents.                            |
| **`/btw <query>`**    | Utilities      | â€”                          | Ask a side question in the background without interrupting the main conversation.        |
| **`/clear`**          | Utilities      | â€”                          | Clear the terminal and reset active conversation contexts.                               |
| **`/config`**         | Configurations | `/settings`                | Open the interactive Settings Editor Overlay.                                            |
| **`/diff`**           | Utilities      | â€”                          | Show unified diff representations of all modified workspace files.                       |
| **`/exit`**           | Core           | â€”                          | Close the TUI session and restore your host shell.                                       |
...
| **`/permissions`**    | Configurations | â€”                          | Switch between global permission presets (`request-review`, `always-proceed`, `strict`). |
...
| **`/statusline`**     | Configurations | â€”                          | Open the Status Bar customization overlay.                                               |
| **`/tasks`**          | Tools & Tasks  | â€”                          | Open the Task Manager Panel to monitor background shell execution logs.                  |
| **`/title [on/off]`** | Configurations | â€”                          | Toggle or set terminal window title updates.                                             |
| **`/usage`**          | Utilities      | â€”                          | Launch the offline developer help manual inside the terminal.                            |
