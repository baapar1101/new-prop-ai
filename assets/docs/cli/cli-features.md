...
text: Selecting a subagent from the panel opens a full-screen detail view. This view shows the entirety of the subagentâ€™s conversation, including its steps, thoughts, and tool execution logs.
</Announcement>
