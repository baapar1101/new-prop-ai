...
[ok]   conductor-tools
       ...
       âœ” commands   : 4 legacy commands converted to skills
       - mcpServers : skipped (none detected)
[ok]   google-workspace
       âœ” skills     : 5 skills processed
       - agents     : skipped (none detected)
       âœ” commands   : 2 legacy commands converted to skills
       âœ” mcpServers : 1 server definition migrated to mcp_config.json
```
